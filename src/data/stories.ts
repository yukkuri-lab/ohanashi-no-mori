...
export const stories: Story[] = [
  ...
  // ─── スイミー ────────────────────────────────────
  {
    ...
    pages: [
      ...
      },
      {
        ...
        wordHints: [
          { word: 'いっぴき', reading: 'いっぴき', explanation: '魚や 虫を かぞえるときの ことば。1ぴきのことだよ。' },
  ...
  // ─── どうぶつ園のじゅうい ─────────────────────────
  {
    ...
    pages: [
      ...
      {
        // 場面3：ペンギンのボールペン
        text: '夕方、しいくいんさんから\n電話が かかって きました。\nペンギンが、ボールペンを\nのみこんで しまったと いうことです。\n\nペンギンは 水中で 魚を つかまえて、\n丸ごと のみこみます。\nえさと まちがえて のみこんだのでしょう。\n\n大いそぎで 手当てを して、\nボールペンを とりだす ことが できました。\n早めに 手当て できたので、\nペンギンは 元気に なりました。',
        imageLabel: 'ペンギンの手当て',
