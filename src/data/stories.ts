...
export const stories: Story[] = [
  ...
  // ─── スイミー ────────────────────────────────────
  {
    ...
    questions: [
      {
        id: 'sq1',
        text: 'まぐろは どのように やってきた？',
        speech: 'スイミーの おはなし\nたのしかった？\nクイズだよ！\nまぐろは どのように\nやってきたでしょう？',
        choices: [
          { id: 'a', text: 'ミサイルみたいに\nつっこんで きた' },
          { id: 'b', text: 'そーっと しのびよって きた' },
          { id: 'c', text: 'ゆっくり およいで きた' },
        ],
        correctId: 'a',
        correctFeedback: 'そうだね！すごい はやさで ミサイルみたいに つっこんで きたんだね。',
        incorrectFeedback: 'さいしょの ばめんを おもいだしてみよう',
      },
      {
        id: 'sq2',
        text: 'まぐろから にげられた さかなは だれ？',
        speech: 'つぎのもんだい！\nまぐろから にげられた\nさかなは だれでしょう？',
        choices: [
          { id: 'a', text: 'スイミー' },
          { id: 'b', text: 'あかい さかなたち' },
        ...
        correctId: 'a',
        correctFeedback: 'せいかい！にげられたのは スイミーだけ だったんだね。',
        incorrectFeedback: 'さいしょの ばめんを おもいだしてみよう',
      },
      {
        id: 'sq3',
      ...
      {
        id: 'sq5',
        text: 'いわかげの さかなたちが でてこないのは なぜ？',
        speech: 'むずかしいよ！\nいわかげの さかなたちが\nでてこないのは なぜでしょう？',
        choices: [
          { id: 'a', text: 'おおきな さかなに\nたべられてしまうから' },
          { id: 'b', text: 'うみが つめたいから' },
          { id: 'c', text: 'きゅうけいして いるから' },
        ],
        correctId: 'a',
      ...
      {
        id: 'sq6',
        text: 'スイミーは みんなに なにを おしえた？',
        speech: 'もうすこし！\nスイミーは みんなに\nなにを おしえたでしょう？',
        choices: [
          { id: 'a', text: 'みんな いっしょに\nおおきな さかなの ふりを すること' },
          { id: 'b', text: 'いわかげに かくれる こと' },
          { id: 'c', text: 'はやく にげる こと' },
        ],
        correctId: 'a',
        correctFeedback: 'せいかい！みんな いっしょに おおきな さかなみたいに なったんだね！',
        incorrectFeedback: 'さいごの ばめんを おもいだしてみよう',
      },
      {
        id: 'sq7',
