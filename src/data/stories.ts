...
export const stories: Story[] = [
  ...
  // ─── お手紙 ──────────────────────────────────────
  {
    ...
    pages: [
      {
        // 場面1：がまくんのかなしい時間
        text: 'がまくんは、げんかんの前にこしを下ろしていました。かえるくんがやって来て、言いました。「どうしたんだい、がまくん。」「今、一日のうちのかなしい時なんだ。お手紙をまつ時間なんだよ。だって、ぼく、お手紙をもらったことがないんだ。だれからも。」「いちどもかい。」「いちどもないよ。」',
      ...
      {
        // 場面3：かたつむりに頼む・ふたりで待つ
        text: 'かえるくんは、知り合いのかたつむりくんに会いました。「このお手紙を、がまくんのゆうびんうけに入れてくれないかい。」「まかせてくれよ。すぐやるぜ。」かえるくんはがまくんの家へもどって、お手紙が来ることをそっと話しました。ふたりは、まどの外を見てまちました。',
        imageLabel: 'かたつむりに頼むかえるくん',
        imageSrc: undefined,
      },
      {
        // 場面4：手紙が届いてしあわせ
        text: '「ぼくは、こう書いたんだ。親愛なるがまくん。きみがぼくの親友であることを、うれしく思っています。きみの親友、かえるくんより。」「ああ。とても いいお手紙だ。」ふたりは、げんかんに出て、お手紙の来るのをまっていました。とてもしあわせな気もちで、そこにすわって、長いことまっていました。',
        imageLabel: 'ふたりでお手紙を待つ',
        imageSrc: undefined,
      },
    ],
    questions: [
