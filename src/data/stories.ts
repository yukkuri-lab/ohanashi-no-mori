    ...
    questions: [
      {
        ...
        correctId: 'b',
        correctFeedback: 'せいかい！いちどもお手紙がないなんて、ほんとう？とおどろいたんだね！',
      ...
      },
      {
        ...
        choices: [
          { id: 'a', text: 'がまくんに すこしでも早く お手紙をとどけたかったから' },
          { id: 'b', text: 'かたつむりくんが 家の外を通るのを見かけたから' },
          { id: 'c', text: 'なるべく早く がまくんの家に もどりたかったから' },
        ],
        correctId: 'a',
        correctFeedback: 'せいかい！がまくんに早くお手紙をとどけたくて、とびだしたんだね！',
        incorrectFeedback: 'かえるくんが外にとびだした場面を もういちど よんでみよう！',
      },
      {
        id: 'tegamiq4',
        text: 'かえるくんが「かなしい気分」になったのは、なぜですか？',
        speech: 'さいごのもんだいだよ！\nかえるくんが「かなしい気分」になったのは、なぜですか？',
        choices: [
          { id: 'a', text: 'がまくんが かなしい思いをしていることが、かなしかったから' },
          { id: 'b', text: 'がまくんのことが よく 分からなかったから' },
          { id: 'c', text: 'がまくんが きげんをなおしてくれなかったから' },
        ],
        correctId: 'a',
        correctFeedback: 'せいかい！友だちがかなしんでいると、じぶんもかなしくなるんだね！',
        incorrectFeedback: 'ふたりがげんかんに すわっている場面を もういちど よんでみよう！',
      },
    ],
  },
