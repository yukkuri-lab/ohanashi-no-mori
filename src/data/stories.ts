...
export const stories: Story[] = [
  ...
  // ─── お手紙 ──────────────────────────────────────
  {
    ...
    pages: [
      {
        // 場面1：がまくんのかなしい時間
        text: 'がまくんは、げんかんの前にすわっていました。かえるくんがやって来て、言いました。「どうしたんだい、がまくん。なんだかかなしそうだね。」「うん、そうなんだ。今は一日のうちのかなしい時なんだ。お手紙をまつ時間なんだよ。」',
        imageLabel: 'げんかんに座るがまくん',
        imageSrc: undefined,
      },
      {
        // 場面2：かえるくんが手紙を書く
        text: '「どうしてかなしいの？」「だって、ぼく、お手紙をもらったことがないんだ。だれからも。」かえるくんは家に帰ると、紙とえんぴつをもってきて、手紙を書きました。「がまくんへ。きみがぼくの親友であることを、とてもうれしく思っています。きみの友だち、かえるより。」',
        imageLabel: '手紙を書くかえるくん',
        imageSrc: undefined,
      },
      {
        // 場面3：かたつむりに頼む・ひみつを話す
        text: 'かえるくんはかたつむりくんに手紙をたのみました。「この手紙を、がまくんのうちへとどけてほしいんだ。」それからかえるくんはがまくんのところへもどって言いました。「がまくん、きみに手紙がくるよ。ぼくからのだよ。」「ほんとうに！」がまくんの顔が明るくなりました。',
        imageLabel: 'かたつむりに頼むかえるくん',
        imageSrc: undefined,
      },
      {
        // 場面4：手紙が届く
        text: '二人はげんかんにすわって、いっしょに手紙がくるのをまちました。四日後、かたつむりくんが手紙をとどけてくれました。がまくんは手紙を読みました。「かえるくん、こんなすてきな手紙を、ありがとう。」二人は、とてもしあわせな気もちになりました。',
        imageLabel: '手紙が届いた！',
        imageSrc: undefined,
      },
    ],
