...
export interface WordHint {
  word: string         // 本文に登場するそのままの語
  reading: string      // ひらがなの読み
  explanation: string  // 1〜2文の簡単な説明（1年生向け）
}
...
export interface StoryPage {
  ...
  wordHints?: WordHint[] // ことばのふくろ：難しい言葉の説明
}
    ...
    pages: [
      {
        ...
        imageSrc: '/story1.jpg',
        wordHints: [
          { word: 'しばかり',  reading: 'しばかり',  explanation: '山の 草や木を きりとること。むかしの ひとたちの しごとだよ。' },
          { word: '一休み',   reading: 'ひとやすみ', explanation: 'すこしの あいだ やすむこと。' },
        ],
      },
      {
        // 場面2: おむすびがころころ
        ...
        imageSrc: '/story2.jpg',
        wordHints: [
          { word: 'じめん',   reading: 'じめん',    explanation: '土の おもてのこと。わたしたちが ふんでいる ところだよ。' },
          { word: 'ころりん',  reading: 'ころりん',  explanation: 'まるい ものが ころがって おちる ようす。' },
        ],
      },
      {
        // 場面3: ねずみたちが歌っている
        ...
        imageSrc: '/story3.jpg',
        wordHints: [
          { word: '歌声',      reading: 'うたごえ',   explanation: 'うたっているときの こえのこと。' },
          { word: 'のぞいてみる', reading: 'のぞいてみる', explanation: 'かおを ちかづけて そっと みること。' },
        ],
      },
      {
        // 場面4: ねずみからお礼
        ...
        imageSrc: '/story4.jpg',
        wordHints: [
          { word: 'おれい',    reading: 'おれい',    explanation: 'ありがとうの きもちで おかねや ものを わたすこと。' },
          { word: 'たからもの', reading: 'たからもの', explanation: 'とても たいせつで だいじにしている もののこと。' },
        ],
      },
    ],
    questions: [
      {
        ...
        correctId: 'a',
        correctFeedback: 'そうだね！山へ いったんだね。',
    ...
    pages: [
      {
        ...
        wordHints: [
          { word: 'ふきのとう', reading: 'ふきのとう', explanation: 'はるに 土の中から めを だす くさ。まるくて かわいいよ。' },
          { word: '竹やぶ',    reading: 'たけやぶ',   explanation: '竹が たくさん はえている ばしょのこと。' },
          { word: 'ふんばる',  reading: 'ふんばる',   explanation: 'ちからを いっぱい いれて がんばること。' },
        ],
      },
      {
        // 場面2: 雪と竹やぶ
        ...
        wordHints: [
          { word: 'かげ',     reading: 'かげ',     explanation: 'ひかりが あたらない くらいばしょのこと。木や 建物の うしろがわだよ。' },
          { word: 'ざんねん', reading: 'ざんねん', explanation: 'うまくいかなくて かなしいな とおもうこと。' },
        ],
      },
      {
        // 場面3: はるかぜ登場
        ...
        wordHints: [
          { word: 'せのびして', reading: 'せのびして', explanation: 'せいを のばして たかく なろうとすること。' },
          { word: 'おまちどお', reading: 'おまちどお', explanation: 'またせて ごめんね、という あいさつのことば。' },
        ],
      },
      {
        // 場面4: 春が来た
        ...
        wordHints: [
          { word: 'もっこり', reading: 'もっこり', explanation: 'まるく ふくらんで でてくる ようすのことば。' },
          { word: 'すっかり', reading: 'すっかり', explanation: 'のこらず ぜんぶ そうなった ようす。すっかり 春＝ほんとうに 春になった、ということ。' },
        ],
      },
    ],
    questions: [
      {
        ...
        correctId: 'a',
        correctFeedback: 'そうだね！ふきのとうが 雪を おもたいと いっていたね！',
      ...
      },
      {
        ...
        correctId: 'b',
        correctFeedback: 'そうだね！雪が ふきのとうに 「ごめんね」と いったんだね。',
        incorrectFeedback: 'だいじょうぶ、もういっかい',
        pageIndex: 1,
      },
      {
        ...
        correctId: 'a',
        correctFeedback: 'そのとおり！竹やぶのかげになって おひさまが あたらないから とけられないんだね。',
      ...
      },
      {
        ...
        correctId: 'c',
        correctFeedback: 'せいかい！竹やぶが かげに なってしまって もうしわけない、と いったんだね。',
        incorrectFeedback: 'もういちど みてみよう',
        pageIndex: 1,
      },
      {
        ...
        correctId: 'c',
        correctFeedback: 'そうだね！ふきのとうが もっこりと 顔を だしたんだね。かわいいね！',
      ...
      },
      {
        ...
        correctId: 'b',
        correctFeedback: 'そうだね！「もう、すっかり 春です」って かいてあったね！',
        incorrectFeedback: 'さいごの ばめんを おもいだしてみよう',
        pageIndex: 3,
      },
      {
        id: 'fq8',
        text: 'ふきのとうは どんな 気もちで 顔を だせたのかな？',
        speech: 'ふきのとうは どんな 気もちで 顔を だすことが できたと おもう？',
        choices: [
          { id: 'a', text: 'やっと そとに でられて\nうれしい 気もち' },
          { id: 'b', text: 'まだ こわくて\nどきどきした 気もち' },
          { id: 'c', text: 'つかれて もう\nやすみたい 気もち' },
        ],
        correctId: 'a',
        correctFeedback: 'そうだね！ずっと「外が みたいな」と ふんばっていたから、でられたとき きっと とっても うれしかったね！',
        incorrectFeedback: 'ふきのとうが 「よいしょ、よいしょ。外が みたいな。」と いっていた ことを おもいだしてみよう',
        pageIndex: 3,
      },
      {
        id: 'fq9',
        text: 'ふきのとうが 顔を だせた 理由は なんだろう？',
        speech: 'ふきのとうが 顔を だすことが できたのは、どうしてだと おもう？',
        choices: [
          { id: 'a', text: 'ふきのとうが\n一人で ふんばったから' },
          { id: 'b', text: '雪と 竹やぶと 春かぜが\nそれぞれ がんばって つながったから' },
          { id: 'c', text: 'お日さまが すぐに\nてつだってくれたから' },
        ],
        correctId: 'b',
        correctFeedback: 'すごい！雪がとけて、竹やぶがゆれて、春かぜがふいて… みんなが つながって たすけあったから でられたんだね！',
        incorrectFeedback: '雪と 竹やぶと 春かぜが それぞれ なにを したか おもいだしてみよう',
        pageIndex: 3,
      },
    ],
  },
    ...
    pages: [
      {
        ...
        wordHints: [
          { word: 'じく',    reading: 'じく',    explanation: '花や 葉を ささえる みどりの ぼうのこと。' },
          { word: 'しぼむ',  reading: 'しぼむ',  explanation: '花が とじて ちいさく なること。' },
          { word: 'ぐったり', reading: 'ぐったり', explanation: 'ちからなく だらんと なる ようす。' },
        ],
      },
      {
        text: 'けれども、たんぽぽは、\nかれてしまったのでは ありません。\n\n花と じくを しずかに やすませて、\nたねに、たくさんの えいようを\nおくっているのです。\n\nこうして、たんぽぽは、\nたねを どんどん ふとらせるのです。',
        ...
        wordHints: [
          { word: 'かれる',  reading: 'かれる',  explanation: '植物の 花や 葉が かわいて いきなくなること。' },
          { word: 'えいよう', reading: 'えいよう', explanation: 'いきものが そだつために ひつような ものの こと。' },
        ],
      },
      {
        text: 'このころになると、\nたおれていた 花の じくが、\nまた おき上がります。\n\nそうして、せのびをするように、\nぐんぐん のびていきます。\n\nそれは、せいを たかくするほうが、\nわた毛に かぜが よくあたって、\nたねを とおくまで とばすことが\nできるからです。',
        ...
        wordHints: [
          { word: 'せのび',  reading: 'せのび',  explanation: 'せいを のばして たかく なろうとすること。' },
          { word: 'わた毛',  reading: 'わたげ',  explanation: 'たんぽぽの たねの まわりにある ふわふわした しろいもの。' },
        ],
      },
      {
        text: 'よく はれて、かぜのある 日には、\nわた毛の らっかさんは、\nいっぱいに ひらいて、\nとおくまで とんでいきます。\n\nでも、しめりけの おおい 日や、\nあめふりの 日には、\nわた毛の らっかさんは、\nすぼんでしまいます。\n\nわた毛が しめると おもくなって、\nたねを とおくに とばせないからです。',
        imageLabel: 'たんぽぽ 場面4',
        imageSrc: '/tanpopo4.jpeg',
        wordHints: [
          { word: 'らっかさん', reading: 'らっかさん', explanation: 'わた毛のことを らっかさんに たとえたことば。たねを やさしく まもって とばすよ。' },
          { word: 'しめりけ',  reading: 'しめりけ',  explanation: 'くうきに みずが まじって しめった かんじのこと。' },
          { word: 'すぼむ',    reading: 'すぼむ',    explanation: 'ひらいていた ものが ちいさく とじること。' },
        ],
      },
    ],
    questions: [
      {
        ...
        correctId: 'a',
        correctFeedback: 'そうだね！春に きいろい きれいな 花が さくんだね。',
        incorrectFeedback: 'さいしょの ばめんを おもいだしてみよう',
        pageIndex: 0,
      },
      {
    ...
    pages: [
      {
        ...
        wordHints: [
          { word: 'ミサイル', reading: 'ミサイル', explanation: 'まっすぐ すごい はやさで とんでいく ぶきのこと。ここでは まぐろの はやさの たとえだよ。' },
          { word: 'のみこむ', reading: 'のみこむ', explanation: 'かまずに まるごと たべてしまうこと。' },
        ],
      },
      {
        ...
        wordHints: [
          { word: 'にじ色',     reading: 'にじいろ',    explanation: 'あか・きいろ・みどり・あおなど にじのような きれいな いろのこと。' },
          { word: 'いせえび',   reading: 'いせえび',    explanation: 'うみに いる おおきな えびのこと。かたい からを もっているよ。' },
          { word: 'ブルドーザー', reading: 'ブルドーザー', explanation: '土や 砂を おして すすむ おおきな きかい。つよそうだね！' },
        ],
      },
      {
        ...
        wordHints: [
          { word: 'うんと',   reading: 'うんと',   explanation: 'ものすごく たくさん、という いみ。' },
          { word: 'とつぜん', reading: 'とつぜん', explanation: 'おもいがけず いきなり そうなること。' },
        ],
      },
      {
        ...
        wordHints: [
          { word: 'ひとひき', reading: 'ひとひき', explanation: '魚や 虫を かぞえるときの ことば。1ぴきのことだよ。' },
          { word: 'おいだす', reading: 'おいだす', explanation: 'あいてを どこかへ でていかせること。' },
        ],
      },
    ],
    questions: [
      ...
      },
      {
        ...
        id: 'sq4',
        text: 'おもしろい ものを 見る たびに スイミーは どうなった？',
        speech: 'おもしろい ものを 見る たびに、スイミーは どうなったっけ？',
        choices: [
          { id: 'a', text: 'もっと さびしくなった' },
          { id: 'b', text: 'はやく にげようと おもった' },
          { id: 'c', text: 'だんだん 元気を とりもどした' },
        ],
        correctId: 'c',
        correctFeedback: 'せいかい！海の すばらしい ものを 見て だんだん げんきに なったんだね！',
        incorrectFeedback: 'ふたつめの ばめんを おもいだしてみよう',
        pageIndex: 1,
      },
      {
      ...
      },
      {
        ...
        correctId: 'b',
        correctFeedback: 'そうだね！大きな 魚に 食べられるのが こわかったんだね。',
        incorrectFeedback: 'みっつめの ばめんを おもいだしてみよう',
        pageIndex: 2,
      },
      {
        ...
        correctId: 'a',
        correctFeedback: 'せいかい！みんなで じゆうに 海を およぐ ほうほうを 考えたんだね。',
        incorrectFeedback: 'みっつめの ばめんを おもいだしてみよう',
        pageIndex: 2,
      },
      {
        ...
        choices: [
          { id: 'a', text: '岩かげに かくれて じっとして いる こと' },
          { id: 'b', text: '大きな 魚の ふりを して\nいっしょに はなれずに およぐ こと' },
          { id: 'c', text: 'ばらばらに にげて 海の そこに もぐる こと' },
        ],
        correctId: 'b',
        correctFeedback: 'そうだね！みんなで かたちを まもって 大きな 魚に なったんだね！',
        incorrectFeedback: 'さいごの ばめんを おもいだしてみよう',
        pageIndex: 3,
      },
      {
    ...
    pages: [
      {
        ...
        wordHints: [
          { word: 'かしこまりました', reading: 'かしこまりました', explanation: '「わかりました」の ていねいな いいかた。おみせで よく つかうことばだよ。' },
          { word: 'おねだん',        reading: 'おねだん',        explanation: 'ものを かうときに はらう おかねの こと。' },
        ],
      },
      {
        // 場面2: お金が足りない / 空っぽのさいふ / 店長さんが「ありますよ」
        text: 'ミリーは、おさいふを とりだしました。\nでも、ちょっと たりないみたいです。\n「あの、もうすこし やすいの ありますか。」\n「どのくらいが よろしいですか。」\n「あの、このくらい。」\nおさいふの 中を みせると、からっぽでした。\nみせのひとは てんじょうを みあげて、\n「あっ、ありますよ！」と さけびました。',
        imageLabel: 'ミリー 場面2',
        imageSrc: '/millie2.jpeg',
        wordHints: [
          { word: 'からっぽ',  reading: 'からっぽ',  explanation: 'なにも はいっていない こと。' },
          { word: 'てんじょう', reading: 'てんじょう', explanation: 'へやの いちばん うえの おもてのこと（天井）。' },
        ],
      },
      {
        ...
        wordHints: [
          { word: 'けっこうです', reading: 'けっこうです', explanation: '「いりません」「しなくて いいです」という ていねいな いいかた。' },
          { word: 'そうぞう',    reading: 'そうぞう',    explanation: 'あたまの 中で ないものを おもいうかべること。' },
        ],
      },
      {
        // 場面4: ケーキやさん・花やさん・公園でぼうしが変わる
        text: 'ケーキやさんの 前を とおると、\nぼうしは、ケーキの ぼうしに なりました。\n花やさんを とおりすぎると、\n花いっぱいの ぼうしに なりました。\n公園では、ふんすいの ぼうしに なりました。\nミリーの すてきな ぼうしは、\nいつも あたらしい ぼうしに\nへんしんして いくのでした。',
        imageLabel: 'ミリー 場面4',
        imageSrc: '/millie4.jpeg',
        wordHints: [
          { word: 'ふんすい', reading: 'ふんすい', explanation: 'みずが たかく ふきあがる しせつ。こうえんなどに あるよ。' },
          { word: 'へんしん', reading: 'へんしん', explanation: 'ぜんぜん ちがう かたちや ようすに かわること。' },
        ],
      },
    ],
    questions: [
    ...
    pages: [
      {
        ...
        wordHints: [
          { word: 'げんかん',      reading: 'げんかん',      explanation: 'おうちの いりぐちのこと。そとと なかを つなぐばしょだよ。' },
          { word: 'こしを下ろす',  reading: 'こしをおろす',  explanation: 'すわること。' },
        ],
      },
      {
        ...
        wordHints: [
          { word: '気分', reading: 'きぶん', explanation: 'そのときの こころもちのこと。かなしい気分＝かなしいきもち。' },
        ],
      },
      {
        // 場面3：かえるくんが手紙を書く
        ...
        wordHints: [
          { word: '大いそぎ', reading: 'おおいそぎ', explanation: 'とても いそいで かけること。' },
          { word: '親愛なる', reading: 'しんあいなる', explanation: 'だいすきな、という いみの ていねいな いいかた。' },
          { word: '親友',    reading: 'しんゆう',    explanation: 'とても なかのいい ともだちのこと。' },
          { word: 'ふうとう', reading: 'ふうとう',   explanation: 'てがみを いれる かみぶくろのこと。' },
        ],
      },
      {
        // 場面4：かたつむりくんに頼む
        ...
        wordHints: [
          { word: 'ゆうびんうけ', reading: 'ゆうびんうけ', explanation: 'おうちの まえにある、てがみを うけとる はこのこと。' },
        ],
      },
      {
        ...
        wordHints: [
          { word: 'お昼ね', reading: 'おひるね', explanation: 'ひるまに ねること。' },
          { word: 'ながめる', reading: 'ながめる', explanation: 'とおくを みわたすように じっと みること。' },
        ],
      },
      {
        // 場面6：手紙の内容・しあわせにまつ
        ...
        wordHints: [
          { word: 'しあわせ', reading: 'しあわせ', explanation: 'こころが とても あたたかく きもちの いい じょうたいのこと。' },
        ],
      },
    ],
    questions: [
    ...
    pages: [
      {
        ...
        wordHints: [
          { word: '見回り',  reading: 'みまわり', explanation: 'あちこちを まわって ようすを たしかめること。' },
          { word: 'おり',    reading: 'おり',     explanation: 'どうぶつを いれておく てつの かきねのこと。' },
          { word: 'じゅうい', reading: 'じゅうい', explanation: 'どうぶつの びょうきや けがを なおす しごとの ひとのこと。' },
        ],
      },
      {
        // 場面2：いのししの赤ちゃん
        ...
        wordHints: [
          { word: 'しいくいん', reading: 'しいくいん', explanation: 'どうぶつえんで どうぶつの せわを する しごとの ひとのこと。' },
          { word: 'いのしし',   reading: 'いのしし',   explanation: '山や 野原に いる どうぶつ。ぶたに にているよ。つよくて はやいよ！' },
        ],
      },
      {
        // 場面3：ペンギンのボールペン
        ...
        wordHints: [
          { word: '手当て',  reading: 'てあて',    explanation: 'けがや びょうきを なおすための しごとのこと。' },
          { word: '大いそぎ', reading: 'おおいそぎ', explanation: 'とても いそいで かけること。' },
        ],
      },
      {
        ...
        wordHints: [
          { word: 'ちりょう', reading: 'ちりょう', explanation: 'びょうきや けがを なおすこと。' },
          { word: 'ようやく', reading: 'ようやく', explanation: 'やっと・ついに、という いみ。' },
        ],
      },
    ],
    questions: [
    ...
    pages: [
      {
        ...
        imageSrc: '/ame1.jpeg',
        wordHints: [
          { word: '一人じゃ', reading: 'ひとりじゃ', explanation: 'ひとりでは、という いみ。じゃ＝では のことだよ。' },
        ],
      },
      {
        // 場面2：やねとつちのうた
        ...
        imageSrc: '/ame2.jpg',
        wordHints: [
          { word: 'やね', reading: 'やね', explanation: 'おうちの いちばん うえの ぶぶん。あめが あたる ところだよ。' },
        ],
      },
      {
        // 場面3：かわとはなのうた
        text: 'あめと 川と いっしょに 川のうた\nあめと 花と いっしょに 花のうた\nあめは だれとも なかよし、\nどんな うたでも しってるよ。',
        imageLabel: '川と花に雨が降る',
        imageSrc: '/ame3.jpeg',
        wordHints: [
          { word: 'なかよし', reading: 'なかよし', explanation: 'なかが よいこと・ともだちの こと。' },
        ],
      },
      {
        // 場面4：雨の音
        ...
        imageSrc: '/ame4.jpg',
        wordHints: [
          { word: 'とんとん', reading: 'とんとん', explanation: 'ものに やさしく あたる ときの おとを あらわす ことば。' },
          { word: 'リズム',   reading: 'リズム',   explanation: 'くりかえしの ひょうしのこと。音楽で つかうことばだよ。' },
        ],
      },
    ],
    questions: [
      {
        ...
        incorrectFeedback: 'もういちど しを よんでみよう。やねと土と川と花が でてくるよ。',
        pageIndex: 2,
      },
      {
        id: 'aq2',
      ...
      },
      {
        ...
        choices: [
          ...
          { id: 'c', text: 'リズムを かんじながら よむ' },
        ],
        correctId: 'c',
        correctFeedback: 'そうだね！リズムを かんじながら よむと たのしいね！',
        incorrectFeedback: 'とんとん、ぴんちん、つんつん…　おとの リズムを かんじてみよう！',
        pageIndex: 3,
      },
    ],
  },
